...
public class Perft
{
	...
	public static long runPerftSuite()
	{
		...
		System.out.println("Total Tracked Time: " + (moveGenTime + movePieceTime + moveBackTime));
	...
	public static boolean runPerft(String perft)
	{
		...
		for (int i = 1; i < perftData.length; i++)
		{
			...
			long expectedCount = Long.parseLong(countString);
			
			long startTime = System.currentTimeMillis();
			long resultCount = countMoves(depth, 0);
